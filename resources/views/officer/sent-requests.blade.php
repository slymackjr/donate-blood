        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link  ps-4 pe-4 text-primary" href="{{route('staff.viewRequests')}}"><i class="fa-solid fa-list p-2"></i>Sent Requests</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link  ps-4 pe-4 text-white" href="{{route('staff.aboutUs')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="fa-solid fa-info p-2"></i>  About Us
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link  ps-4 pe-4 text-white" href="{{route('staff.contactUs')}}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div id="carouselExample" class="carousel">
          <div class="carousel-inner">
            ...
            <div class="carousel-item p-2">
                <div class="card bg-gradient border-0 rounded-4 shadow">
                    <div class="card-body text-black">
                        <h5 class="card-title text-center text-uppercase mb-4">Donor Request</h5>
                        <ul class="list-unstyled">
                            <li><strong>Name:</strong> {{$row['full_name']}}</li>
                            <li><strong>Gender:</strong> {{$row['gender']}}</li>
                            <li><strong>Location:</strong> {{$row['address']}}</li>
                            <li><strong>Blood Group:</strong> {{$row['blood_type']}}</li>
                            <li><strong>Phone Number:</strong> {{$row['phone_number']}}</li>
                            <li><strong>Appointment Date:</strong> {{$row['request_date']}}</li>
                        ...
                        <form action="{{ route('staff.createRequest') }}" method="POST">
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-success btn-lg">Cancel Request</button>
                            </div>
                        </form>
                    </div>
                </div>
